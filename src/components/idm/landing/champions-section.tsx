            ...
            >
              <div
                ...
                style={{
                  ...
                  border: '2px solid rgba(239,249,35,0.4)',
                }}
              >
                {/* 4px Gold Accent Bar */}
                <div
                  className="h-1"
                  style={{ backgroundColor: '#EFF923' }}
                />
                ...
                <div className="relative z-10 p-6 sm:p-8">
                  ...
                  {championVideoUrl && onVideoPlay && (
                    ...
                    >
                      <Play className="w-4 h-4" style={{ color: '#EFF923', fill: '#EFF923' }} />
                      <span className="text-xs font-bold" style={{ color: '#EFF923' }}>Champion Video</span>
                    </button>
                  )}
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    <div
                      ...
                      style={{ backgroundColor: 'rgba(239,249,35,0.12)' }}
                    >
                      <Trophy className="w-6 h-6" style={{ color: '#EFF923' }} />
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        <span
                          ...
                          style={{
                            backgroundColor: 'rgba(239,249,35,0.12)',
                            color: '#EFF923',
                            border: '1px solid rgba(239,249,35,0.2)',
                          }}
                        >
                          Liga IDM
                        </span>
                        <span
                          className="text-[9px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-lg"
                          style={{
                            backgroundColor: 'rgba(239,249,35,0.08)',
                            color: '#EFF923',
                    ...
                    <div className="flex flex-col items-center text-center sm:text-left sm:flex-row gap-4 flex-1">
                      <div className="relative">
                        <div
                          ...
                          style={{
                            border: '2px solid rgba(239,249,35,0.3)',
                            backgroundColor: 'rgba(239,249,35,0.05)',
                          }}
                        >
                          <ClubLogoImage
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-3">
                          ...
                          >
                            <Users className="w-3 h-3" />
                            {leagueData.ligaChampion.members.filter((m: { division: string }) => m.division === 'female').length} Cewe
                          </span>
                          <span
                            className="text-[10px] font-bold px-2.5 py-1 rounded-lg flex items-center gap-1"
                            style={{
                              backgroundColor: 'rgba(239,249,35,0.1)',
                              color: '#EFF923',
                              border: '1px solid rgba(239,249,35,0.2)',
                            }}
                          >
                          ...
                          >
                            <div
                              ...
                              style={{
                                ...
                                ...(member.role === 'captain' ? { ringColor: 'rgba(239,249,35,0.5)' } : {}),
                              }}
                            >
                              <AvatarMedia
                  ...
                  <div className="mt-6 flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-1.5" style={{ color: 'rgba(239,249,35,0.4)' }}>
                    ...
                    {hasChampions && winnerTeam ? (
                      <div className="relative z-10 px-4 sm:px-5 lg:px-6 pb-2">
                        <div
                          ...
                          style={{ background: 'rgba(249, 203, 37, 0.04)' }}
                        >
                          ...
                          {selected && selected.prizePool > 0 && (
                            <div
                              ...
                              style={{ background: 'linear-gradient(135deg, rgba(249,203,37,0.15), rgba(249,203,37,0.05))' }}
                            >
