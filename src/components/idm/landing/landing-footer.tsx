...
function SocialLink({ href, label, children }: { href: string; label: string; children: React.ReactNode }) {
  return (
    <a
      ...
      aria-label={label}
      className="footer-social-enhanced focus-ring-premium p-3 rounded-xl text-muted-foreground hover:text-[#d4a853] hover:bg-[rgba(212,168,83,0.08)] hover:shadow-[0_0_16px_2px_rgba(212,168,83,0.12)] transition-all duration-300"
    >
      {children}
    </a>
  );
...
function QuickLink({ label, sectionId }: { label: string; sectionId: string }) {
  ...
  return (
    <button
      onClick={handleClick}
      className="focus-ring-premium text-muted-foreground text-sm hover:text-[#d4a853] transition-colors duration-200 cursor-pointer py-0.5 text-left"
    >
      {label}
    </button>
  );
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 sm:gap-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2.5 mb-2">
              <div className="footer-logo-glow w-7 h-7 rounded-md overflow-hidden shrink-0 ring-1 ring-[rgba(212,168,83,0.2)]">
                <Image
                  src={logoUrl}
                  alt="IDM Logo"
                  width={28}
        ...
        <div className="flex flex-col items-center sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-3">
            ...
            <span
              ...
              style={{
                background: 'linear-gradient(135deg, rgba(212,168,83,0.4), rgba(245,230,200,0.3))',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
              }}
            >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
            ...
            <span className="text-muted-foreground/30 text-[10px] tracking-wider uppercase flex items-center gap-1.5">
              ...
              <span
                ...
                style={{
                  background: 'linear-gradient(135deg, rgba(212,168,83,0.5), rgba(245,230,200,0.4))',
                  WebkitBackgroundClip: 'text',
                  WebkitTextFillColor: 'transparent',
                }}
              >
